...
public class Main {
    public static void main(String[] args) {
        ...
        //Fazer função para executar somente ao apertar o botão
        String cpf = "12345678912";
        System.out.println(gerarVerificador(cpf));
    }

    public String gerarVerificador(String cpf){
